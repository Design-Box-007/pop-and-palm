        ...
        <section id="gallery">
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="gallerypage-description text-center w-75">
              The Gallery section is a visually rich area showcasing a curated
              collection of images from past events. Each image captures the
              essence of the event, whether it's a beautifully decorated venue,
              a lively birthday party, or a sophisticated corporate gathering.
            </div>
          </div>
        </section>
      </div>
        ...
        <div className="gallerypage-categories">
          {categories.map((categoryName) => (
            <Link
              ...
              className={`gallerypage-category ${
