      ...
      <section className="gallerypage" id="gallery">
        ...
        <div className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="gallerypage-description text-center w-75">
            At Pop & Palm, we offer a comprehensive range of services to bring
            your vision to life. Whether you’re planning an intimate gathering
            or a grand celebration, our dedicated team is here to ensure every
            detail is perfect.
          </div>
        </div>
      </section>
                        ...
                        <div className="col-md-6">
                          <div className="servicepage-card-image-container">
                            <img
                              ...
                              width="100%"
                              alt={service.title}
                              className="servicepage-card-image"
                            />
                          </div>
                        </div>
                        <div className="col-md-6 my-3 d-flex flex-column justify-content-evenly">
                          <h2 className="servicepage-card-title">
                            {service.title}
                          </h2>
                          <p className="servicepage-card-description">
                            {service.description}
                          </p>
                          <div className="d-sm-flex">
                            <HashLink
                              smooth
                              to={`/services/${formatToHyphenated(
                                service.title
                              )}#top`}
                              onClick={scrollToTop}
                            >
