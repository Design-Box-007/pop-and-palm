        ...
        <div className="col-md-6">
          <TopToBottomReveal>
            <div className="description">
              Founded by two friends who shared a passion for creative artistry,
              Pop & Palm Events began its journey with humble origins. Initially
              focusing on crafting memorable birthday parties for their own
              children, they discovered a shared talent and enthusiasm for event
              decor. With little formal business knowledge but a wealth of
              creativity and determination, they took the leap into professional
              event planning.
            </div>
          </TopToBottomReveal>
        </div>
