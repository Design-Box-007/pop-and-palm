      ...
      <section id="gallery">
        <div className="d-flex flex-column justify-content-center align-items-center blogDetail">
          ...
          <div className="gallerypage-description text-center w-75">
            Discover inspiration and expert insights in our blog to make your
            next event unforgettable. From design trends to planning tips, we’ve
            got everything you need to create a seamless experience.
          </div>
        </div>
      </section>
    </section>
