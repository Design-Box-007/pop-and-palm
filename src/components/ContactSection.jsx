    ...
    <div className="contact-section">
      ...
      <LeftToRightReveal>
        <div className="flex-heading">
          ...
          <div className="subtitle"> Expecting your calls</div>
        </div>
      </LeftToRightReveal>
      <VisibleReveal>
          ...
          <div className="row">
            ...
            <div className="col-md-6 my-4 d-flex flex-column gap-2">
              ...
              <div className="contact-subtitle">
                Get in touch with us to bring your event vision to life! Whether
                you have specific decor ideas or need expert guidance, we're
                here to help create unforgettable experiences. Please fill out
                the form with your details, and we'll reach out to discuss your
                event needs. Let’s make your celebration extraordinary!
              </div>
              <form className="mt-3">
                {/* <div className='row'>
